...
- YARN [https://classic.yarnpkg.com/lang/en/d...](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbk5mZjVVb3JjZ0ZEU0ExYjFoZzV5Q2NEU3ZBd3xBQ3Jtc0tuTmhGbWFNQ1ZaZmhoaklIWk9JZEpnSmdnbmJwZnViRExzeXEzYWNnQXZIRG5WRHhKU1hGNkFYREpqU2VnOEsxbWZRMU90RGZ2NDdfRk5CRl91Umx3ZV9aUUpwQUJFZ0hwM2FjLVlYVkJZZU5EQWhmRQ&q=https%3A%2F%2Fclassic.yarnpkg.com%2Flang%2Fen%2Fdocs%2Finstall%2F%23windows-stable&v=mVvuL_a7fFA) 
- NODEJS [https://nodejs.org/en/download](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbDR3bUdJY0JONlVOUnRxcERmcW1FbVhaVEtnZ3xBQ3Jtc0ttaS1ZTDFKZ1BLRXozUFZLWmtFdDkzaUY2cGM1cW5lR1VnLTBFRFJNS190c3hFWUdHVy15eXVwVDkxNWdZLWJzblJsSmdtR1VsLUFtc3RrbGZGdHNEdm14UnVfdnRXN2tydlhuc3Jud2lHQ3hoTzd5SQ&q=https%3A%2F%2Fnodejs.org%2Fen%2Fdownload&v=mVvuL_a7fFA) 
- RAILS INSTALLER [https://railsinstaller.org/](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqbkV6QmY2RVZOcFFWcmlYUUJyaEtFSjJKUmZHd3xBQ3Jtc0tuTVl0QnZOMU5xRmRkT1Vmcm1qOU45aEhka3NQdkE2VklrSGxneGxsVGN3UFZKb0Q0QUFVdWZyTXJkYWMxaGVkaGxiYnBpZVlqOHluRHpfb1ByWmxmSmZ4NFZObjJBMTJ6REh3eFpnQ1lCZVMwNDh5SQ&q=https%3A%2F%2Frailsinstaller.org%2F&v=mVvuL_a7fFA) 
- RUBYINSTALLER [https://rubyinstaller.org/](https://www.youtube.com/redirect?event=video_description&redir_token=QUFFLUhqa0tqS0ljTndGMjdvdTcxRDU3b3A1TkdmMkx5UXxBQ3Jtc0tudW1JWWRpbHlxR1ZsX2pQZmYzTm1BcmpDX1puei1MSko1YWEwbDJ1YjJSQklnSXlkNTJwN1E3V3EwT2Z1T3pfeTJ3b0JfVXN0RXpzTERQSWZyV2FFbVdNZDhyaUdVRUpDM1NueTd3QWxxRzNoaGtyQQ&q=https%3A%2F%2Frubyinstaller.org%2F&v=mVvuL_a7fFA)
- Gem install rails
- 
##### Table of Contents
...
The `begin-rescue` block is used to handle exceptions. Code inside `begin` runs normally until an error occurs, at which point `rescue` takes over.


```begin   # Code that may cause an error   result = 10 / 0 rescue   # Code to run if an error occurs   puts "An error occurred!" end```


Install Ruby on rails Steps-
![[rubyinstall.png]]